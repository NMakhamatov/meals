    ...
    return Scaffold(
      ...
      body: WillPopScope(
        onWillPop: () async {
          ...
          return false; // Возвращаем false потому что не хотим сделать "назад" 2 раза, так как мы уже вызываем pop вручную. Если бы мы сохранили состояние напр, в БД, вместо вызова pop,
          // то нужно было бы вернуть true
        },
        child: Column(
          children: [
            SwitchListTile(
